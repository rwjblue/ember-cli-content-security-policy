...
module.exports = {
  'csp-headers': {
    ...
    run: function(options) {
      ...
      let { reportOnly, policy } = calculateConfig(environment, ownConfig, runConfig, ui);
      ...
      this.ui.writeLine(chalk.dim.cyan('# for Apache: Header set ' + header + ' "..."'));
      this.ui.writeLine(chalk.dim.cyan('# for Nginx : add_header ' + header + ' "...";') + '\n');
